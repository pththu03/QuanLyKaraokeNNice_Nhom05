...
public class QuanLyDichVuController implements ActionListener, MouseListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		} else if(o.equals(giaoDienQuanLyDichVu.btnXoaLoaiDichVu)) {
			giaoDienQuanLyDichVu.chonXoaLoaiDichVu();
		} else if(o.equals(giaoDienQuanLyDichVu.btnChinhSuaLoaiDichVu)) {
			giaoDienQuanLyDichVu.chonChinhSuaLoaiDichVu();
		}
	}
